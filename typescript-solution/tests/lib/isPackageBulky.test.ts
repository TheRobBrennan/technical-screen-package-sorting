...
describe('isPackageBulky', () => {
  ...
  test('returns false for packages with the longest dimension (width, height, or length) just shy of the max dimension', () => {
  ...
  test('returns true for packages with one dimension (width, height, or length) equal to the max dimension', () => {
  ...
  test('returns true for packages with one dimension (width, height, or length) greater than the max dimension', () => {
